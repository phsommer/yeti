...
public interface ITinyOSDebugLaunchConstants {
	 ...
	 */
	public static final String TINYOS_DBG_LAUNCH_ID = "tinyos.yeti.debug.launch"; //$NON-NLS-1$

	/**
	 * This is the launch type id.
	 */
	public static final String ID_LAUNCH_TINYOS_DEBUG = "tinyos.yeti.debug.launch.configurationType"; //$NON-NLS-1$
