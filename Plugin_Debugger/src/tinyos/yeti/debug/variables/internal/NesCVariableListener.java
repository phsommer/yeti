...
public class NesCVariableListener implements IDebugEventSetListener, INesCVariableListener {
	...
	/* (non-Javadoc)
	 * @see tinyos.yeti.debug.util.variables.internal.INesCVariableListener#targetIsRunning()
	 */
	...
	/* (non-Javadoc)
	 * @see tinyos.yeti.debug.util.variables.internal.INesCVariableListener#targetIsTerminated()
	 */
	...
	/* (non-Javadoc)
	 * @see tinyos.yeti.debug.util.variables.internal.INesCVariableListener#stop()
	 */
	public void stop() {
