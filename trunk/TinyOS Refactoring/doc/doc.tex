...
\subsection{org.eclipse.ui.*}
A lot of Extension Points are Provided by the org.eclipse.ui Plugin. We will use some of them to introduce our 

\subsection{org.eclipse.core.expressions.propertyTesters}
...
This class is especially interesting, since it uses the {\it InputValidation} class to avoid renaming of identifiers to non C names.
