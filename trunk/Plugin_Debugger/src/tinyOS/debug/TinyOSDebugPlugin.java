...
import tinyOS.debug.CDTAbstractionLayer.CDTVariableManager;
import tinyOS.debug.variables.INesCVariableListener;
import tinyOS.debug.variables.internal.NesCVariableListener;
...
public class TinyOSDebugPlugin extends AbstractUIPlugin {
	...
	/**
	 * The plug-in identifier (value <code>"tinyOS.debug"</code>).
	 */
	public static final String PLUGIN_ID = "tinyOS.debug";
